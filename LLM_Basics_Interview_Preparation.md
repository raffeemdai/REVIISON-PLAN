...
Tokenization means breaking your sentence into small pieces — like words or parts of words — so the model can understand and work with them one piece at a time.
...
![Attention example with the word bank]
